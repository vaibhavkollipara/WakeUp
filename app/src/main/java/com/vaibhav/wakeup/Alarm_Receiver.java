...
public class Alarm_Receiver  extends BroadcastReceiver{
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Integer sound_choice = intent.getExtras().getInt("aound_choice");

        Log.e("The whale choice is ", sound_choice.toString());
        ...
        service_intent.putExtra("sound_choice", sound_choice);
